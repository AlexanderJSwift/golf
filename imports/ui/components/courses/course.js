    ...
    if (title !== '' && event.keyCode === 13) {
        updateCourse.call({
            ...
            if (error) {
                ...
                Bert.alert('Course updated!', 'success');
            }
        });
    }
};

const handleRemoveCourse = (documentId, event) => {
        ...
        <Row>
            <Col xs={ 8 } sm={ 10 }>
                <FormControl
                    ...
                    onKeyUp={ handleUpdateCourse.bind(this, document._id) }
                />
            </Col>
            <Col xs={ 4 } sm={ 2 }>
                <Button
                    bsStyle="danger"
                    className="btn-block"
                    onClick={ handleRemoveCourse.bind(this, document._id) }>
                    Remove
                </Button>
            </Col>
        </Row>
